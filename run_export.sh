...
export_folder='superpoint_coco_magic_leap_pretrained'
...
python3 evaluation.py /scratch/aiscience/logs/superpoint/$export_folder/predictions --repeatibility --homography --outputImg --plotMatching
